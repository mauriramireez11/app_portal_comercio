...
Selecciona tipo de soporte
     ...
     Click element              xpath=//android.widget.TextView[@text="vPOS"]
     # presiona el boton siguiente
     Click element              xpath=//android.widget.TextView[@text='Siguiente']
     Sleep                      1s
     # selecciona Reclamar pruebas de integracion
     Click element              xpath=//android.widget.TextView[@text="Pruebas de integración (desarrollo)"]
     # presiona el boton siguiente
     Click element              xpath=//android.widget.TextView[@text='Siguiente']
