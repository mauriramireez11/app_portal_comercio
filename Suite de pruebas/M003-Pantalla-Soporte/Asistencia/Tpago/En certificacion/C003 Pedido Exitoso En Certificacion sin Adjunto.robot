...
Pedido exito de facturacion sin adjunto
     ...
     Sleep                      2s
     Swipe                      39  1218  47  861
     # selecciona facturacion
     Click element              xpath=//android.widget.TextView[@text='TPago']
     # presiona el boton siguiente
     Click element              xpath=//android.widget.TextView[@text='Siguiente']
     Sleep                      1s
     # selecciona Reclamar facturacion
     Click element              xpath=//android.widget.TextView[@text='En certificación']
     # presiona el boton siguiente
     Click element              xpath=//android.widget.TextView[@text='Siguiente']
...
Captura el número de pedido y consulta II
